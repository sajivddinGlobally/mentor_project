    ...
    if (widget.data && !_profileLoaded && profileAsync.hasValue) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        setState(() {
          ...
          dateController.text =
              formatDate(profileAsync.value!.data!.dob.toString());
          jobRoleController.text = profileAsync.value!.data!.jobRole ?? "";
          jobLocationController.text =
              profileAsync.value!.data!.jobLocation ?? "";
          companyNameController.text =
              profileAsync.value!.data!.jobCompanyName ?? "";
          salaryController.text = profileAsync.value!.data!.salary ?? "";
          gender = profileAsync.value!.data!.gender ?? "";
          eductionController.text =
              profileAsync.value!.data!.educationYear ?? "";
          collegeController.text =
              profileAsync.value!.data!.collegeOrInstituteName ?? "";
          qualification = profileAsync.value!.data!.highestQualification ?? "";
          _profileLoaded = true;
        });
      });
    }
