...
MyListingResModel myListingResModelFromJson(String str) => MyListingResModel.fromJson(json.decode(str));

String myListingResModelToJson(MyListingResModel data) => json.encode(data.toJson());
...
class MyListingResModel {
    ...
    factory MyListingResModel.fromJson(Map<String, dynamic> json) => MyListingResModel(
        status: json["status"],
        total: json["total"],
